    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold text-white mb-4">NESPAK</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#services" className="hover:text-white transition-colors">Design & Planning</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} NESPAK Project. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
